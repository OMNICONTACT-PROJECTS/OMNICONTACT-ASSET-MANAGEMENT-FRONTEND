...
const AssetBulkyUpload = ({ visible, onClose, onSuccess }) => {
  ...
  const handleUpload = async (values) => {
    ...
    try {
      ...
      const response = await assetsServices.bulkUploadAssets(formData);
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleUpload}>
        ...
        <Form.Item label="File Name" name="file_name" initialValue="ASSET_UPLOAD_FILE">
          <Input readOnly />
        </Form.Item>
...
AssetBulkyUpload.propTypes = {
  visible: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccess: PropTypes.func.isRequired,
};

export default AssetBulkyUpload;
