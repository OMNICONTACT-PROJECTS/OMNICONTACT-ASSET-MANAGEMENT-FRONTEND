...
import ViewMyAssetRequestDetails from "./ViewUserAssetRequestDetails";
import NewUserAssetRequest from "./NewUserAssetRequest";
import EditUserAssetRequest from "./EditUserAssetRequest";

export const UserAssetRequestListLoader = async () => {
    try {
